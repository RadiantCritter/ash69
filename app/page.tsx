...
export default function Page() {
  ...
  return (
    <div >
        ...
        <div className="flex flex-col ">
          {messages.map((message, index) => (
            <div key={`message-${index}`} className="flex flex-col md:flex-row">
              ...
              <div className="w-full md:w-1/4 col-4 md:pl-4 ">
      ...
      <div className={`px-2 fixed inset-x-0 bottom-0 w-full bg-gradient-to-b duration-300 ease-in-out animate-in dark:from-zinc-900/10 dark:from-10% peer-[[data-state=open]]:group-[]:lg:pl-[250px] peer-[[data-state=open]]:group-[]:xl:pl-[300px]] mb-4 bring-to-front`}>
        ...
        <div className="mx-auto max-w-xl sm:px-4 ">
          ...
          {messages.length === 0 && (
            <InitialQueries questions={['Write codes for snake game in python?', 'What is PM Modi\'s vision for India@2047?', 'Where do i get best weed in India?']} handleFollowUpClick={handleFollowUpClick} />
          )}
          <form
            ref={formRef}
          ...
          >
            <div className="relative flex flex-col w-full overflow-hidden max-h-60 grow dark:bg-zinc-900 bg-slate-950 rounded-md border sm:px-2">
              <Textarea
                ref={inputRef}
                tabIndex={0}
                onKeyDown={onKeyDown}
                placeholder="I'm Ash, ask me something"
