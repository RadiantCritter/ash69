                ...
                {searchResults.length === 0 ? (
                    ...
                    <>
                        ...
                        {visibleResults.map((result, index) => (
                            <div key={`searchResult-${index}`} className="p-1 w-full md:w-1/3 h-20">
                                <div className="flex items-center space-x-2 dark:bg-zinc-900 bg-gray-100 p-3 rounded-lg h-full">
                        ...
                        <div className="w-full sm:w-full md:w-1/6 p-2">
                            <div
                                onClick={toggleExpansion}
                                className="flex items-center space-x-2 dark:bg-neutral-800 bg-gray-100 p-3 rounded-lg cursor-pointer h-12 justify-center"
                            >
                                {!isExpanded ? (
                                    <>
                                        ...
                                        <span className="text-sm font-semibold dark:text-gray-200 text-gray-700"><MdExpandMore /></span>
                                    </>
                                ) : (
                                    <span className="text-sm font-semibold dark:text-gray-200 text-gray-700"><MdExpandLess />
                                    </span>
                                )}
                            </div>
                        </div>
