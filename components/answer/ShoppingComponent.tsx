        ...
        <>
            {Array.from({ length: 5 }).map((_, index) => (
                <div key={index} className="flex items-center space-x-4">
                    <div className="w-10 h-10 bg-gray-300 dark:bg-gray-900 rounded-full animate-pulse"></div>
                    <div className="flex-grow">
                        <div className="w-2/3 h-4 bg-gray-300 dark:bg-gray-950 rounded animate-pulse mb-2"></div>
                        <div className="w-1/2 h-4 bg-gray-300 dark:bg-gray-950 rounded animate-pulse"></div>
                    </div>
                </div>
            ))}
        </>
        ...
        <div className="bg-white dark:bg-gray-950 shadow-lg rounded-lg p-4 mt-4">
            ...
            {showModal && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div className="bg-white dark:bg-gray-950 rounded-lg shadow-xl max-w-3xl w-full mx-auto overflow-hidden relative">
                        <div className="sticky top-0 bg-white dark:bg-gray-950 px-6 py-4 flex items-center justify-between border-b border-gray-200 dark:border-gray-700">
