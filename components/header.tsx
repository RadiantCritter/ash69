...
export function Header() {
 ...
 const Sidebar = ({ isOpen, onClose }) => {
   ...
   return (
     <div
       className={`fixed inset-y-0 left-0 z-40 w-64 bg-white dark:bg-slate-950 shadow-lg transition-transform duration-300 ease-in-out transform ${isOpen ? 'translate-x-0' : '-translate-x-full'
         }`}
     >
         ...
         <div className="flex-1 px-4 py-6 overflow-y-auto">
           ...
           <div className="mb-4">
             ...
             <div className="relative inline-block w-10 mr-2 align-middle select-none">
               ...
               />
               <label className="block h-6 overflow-hidden bg-slate-950 rounded-full cursor-pointer"></label>
             </div>
           </div>
           <div className="mb-4">
